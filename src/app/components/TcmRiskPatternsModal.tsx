...
interface TcmRiskPatternsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function TcmRiskPatternsModal({
  isOpen,
  onClose,
  patientSafetyProfile,
  onUpdateProfile
}: TcmRiskPatternsModalProps) {
  ...
  useEffect(() => {
    if (isOpen) {
      const loadedCategories = getCategoriesByGroup('tcm_risk_patterns');
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="sr-only">Select TCM Risk Patterns</Dialog.Title>
          ...
          <div className="flex-shrink-0 px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between mb-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900 flex-1 text-center">TCM Risk Patterns</h2>
              <button
                onClick={onClose}
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search TCM patterns..."
