...
export function MedicationsModal({
  ...
  useEffect(() => {
    if (isOpen) {
      const loadedCategories = getCategoriesByGroup('medications');
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="sr-only">Select Medications</Dialog.Title>
          ...
          <div className="flex-shrink-0 px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between mb-3">
              ...
              <h2 className="text-lg font-semibold text-gray-900 flex-1 text-center">Medications</h2>
              <button
                onClick={onClose}
