...
import { Leaf, Pill, FileText, Beaker, StickyNote, LogOut, ShieldCheck, HelpCircle, Settings, User, Eye, Users } from 'lucide-react';
...
export function Navigation({ onToggleNotes, isNotesVisible, onOpenGlobalSettings }: NavigationProps) {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [{ to: '/patients', label: t('nav.patients'), icon: Users, customSvg: undefined }] : []),
  ];
