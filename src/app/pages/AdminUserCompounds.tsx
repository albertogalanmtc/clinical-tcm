...
export default function AdminUserCompounds() {
    ...
    <div className="max-w-7xl mx-auto p-2 sm:p-4 pb-20 sm:pb-4">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Formulas added</h1>
        </div>
        <p className="hidden sm:block text-gray-600">View all compound formulas added by this user</p>
      </div>

      {/* Content - Coming soon placeholder */}
      <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
        <p className="text-gray-500">Detailed compound formula list view - Coming soon</p>
      </div>
    </div>
  );
}