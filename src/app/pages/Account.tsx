        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-xl max-w-md w-full z-50 mx-4 max-h-[90vh] overflow-y-auto">
            <Dialog.Description className="sr-only">
              Confirm account deletion by entering your email and typing DELETE
            </Dialog.Description>
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="space-y-1.5 text-sm text-red-800">
                          <li className="flex items-start gap-2">
                            ...
                            <span>All your data, prescriptions, and custom content will be permanently deleted</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-red-600 font-bold mt-0.5">•</span>
                  ...
                  {userEmail && (
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        Type <span className="font-semibold text-gray-900">{userEmail}</span> to confirm
                      </p>
                      <input
                        id="email-confirm"
                        type="email"
                  ...
                  <div className="mb-6">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      ...
                      <span className="text-sm text-gray-700 select-none">
                        I understand that this action is <span className="font-semibold text-gray-900">permanent and irreversible</span>
                      </span>
                    </label>
                  </div>
                </>
