...
export default function Builder() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] lg:h-[calc(100vh-4rem)] flex flex-col lg:flex-row items-stretch gap-4 lg:gap-6 p-4 lg:p-6 bg-gray-50">
      ...
      <div className="hidden lg:flex lg:flex-col w-72 flex-shrink-0 self-stretch">
        <div className="bg-white rounded-lg border border-gray-200 sticky top-4 max-h-[calc(100vh-6rem)] flex flex-1 min-h-0 flex-col overflow-hidden">
